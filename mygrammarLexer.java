// $ANTLR 3.5 mygrammar.g 2013-02-15 15:22:35
...
public class mygrammarLexer extends Lexer {
	...
	public final void mT__34() throws RecognitionException {
		try {
			int _type = T__34;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:20:7: ( '#include' )
			// mygrammar.g:20:9: '#include'
			{
			match("#include"); 
	...
	public final void mT__35() throws RecognitionException {
		try {
			int _type = T__35;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:21:7: ( 'char' )
			// mygrammar.g:21:9: 'char'
			{
			match("char"); 
	...
	public final void mT__36() throws RecognitionException {
		try {
			int _type = T__36;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:22:7: ( 'else' )
			// mygrammar.g:22:9: 'else'
			{
			match("else"); 
	...
	public final void mT__39() throws RecognitionException {
		try {
			int _type = T__39;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:25:7: ( 'main' )
			// mygrammar.g:25:9: 'main'
			{
			match("main"); 
	...
	public final void mT__40() throws RecognitionException {
		try {
			int _type = T__40;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:26:7: ( 'output' )
			// mygrammar.g:26:9: 'output'
			{
			match("output"); 
	...
	public final void mT__41() throws RecognitionException {
		try {
			int _type = T__41;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:27:7: ( 'outputc' )
			// mygrammar.g:27:9: 'outputc'
			{
			match("outputc"); 
	...
	public final void mT__42() throws RecognitionException {
		try {
			int _type = T__42;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:28:7: ( 'print' )
			// mygrammar.g:28:9: 'print'
			{
			match("print"); 
	...
	public final void mT__43() throws RecognitionException {
		try {
			int _type = T__43;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:29:7: ( 'read' )
			// mygrammar.g:29:9: 'read'
			{
			match("read"); 
	...
	public final void mT__44() throws RecognitionException {
		try {
			int _type = T__44;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:30:7: ( 'readc' )
			// mygrammar.g:30:9: 'readc'
			{
			match("readc"); 
	...
	public final void mT__45() throws RecognitionException {
		try {
			int _type = T__45;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:31:7: ( 'return' )
			// mygrammar.g:31:9: 'return'
			{
			match("return"); 
	...
	public final void mT__46() throws RecognitionException {
		try {
			int _type = T__46;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:32:7: ( 'while' )
			// mygrammar.g:32:9: 'while'
			{
			match("while"); 
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:56:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// mygrammar.g:56:7: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			...
			// mygrammar.g:56:31: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			int _type = NUMBER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// mygrammar.g:59:9: ( ( '-' )? ( DIGIT )+ )
			// mygrammar.g:59:11: ( '-' )? ( DIGIT )+
			{
			// mygrammar.g:59:11: ( '-' )?
			int alt2=2;
	...
	public void mTokens() throws RecognitionException {
		// mygrammar.g:1:8: ( ASSIGN | COMMA | DIV | EQ | GT | GTE | LBRACE | LPAREN | LT | LTE | MINUS | MOD | NEQ | PLUS | RBRACE | RPAREN | SEMICOLON | TIMES | T__34 | T__35 | T__36 | T__37 | T__38 | T__39 | T__40 | T__41 | T__42 | T__43 | T__44 | T__45 | T__46 | ID | WS | CHAR | NUMBER | STRING )
		int alt5=36;
		alt5 = dfa5.predict(input);
		switch (alt5) {
			case 1 :
				// mygrammar.g:1:10: ASSIGN
				{
				mASSIGN(); 
